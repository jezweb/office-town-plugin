...
- Filing every link as a finding
- Surfacing items without the "why us" angle
- Scanning the same sources every day and expecting new signal
- Going deep on items the scout's gut says are noise
