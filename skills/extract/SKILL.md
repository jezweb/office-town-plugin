...
- Inventing details to fill schema slots
- Extracting from training-data memory ("I know Acme is a software company") instead of the source
- Generic summaries ("the email is about a meeting") instead of specific facts
- Re-extracting an entry that already exists — update it instead
